    ...
    tasks.forEach(t => {
        ...
        if (t.subtasks && t.subtasks.length) {
            ...
            progEl.innerHTML = `
                ...
                <div class="pinfo">выполнено ${doneAll}/${total}
                    (✅ ${done}, ❌ ${failed})</div>
            `;
        ...
        if (t.status === "done" && Object.keys(t.result || {}).length) {
            ...
            newHtml = `<div class="running-indicator">Выполняется, подожди…</div>`;
...
// привязка событий к кнопке и полю ввода
